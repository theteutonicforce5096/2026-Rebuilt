...
class SwerveDrivetrainConstants:
    ...
    _max_linear_rate_of_change = (1 / 0.001) * 0.02 * _max_linear_speed # Max speed in 0.25 seconds
    _max_angular_rate_of_change = (1 / 0.001) * 0.02 * _max_angular_speed # Max speed in 0.5 seconds
    ...
    _slip_current: units.ampere = 60.0 #100
