...
class SwerveDrivetrainConstants:
    ...
    # Per-loop (20 ms) velocity deltas used to slew-limit teleop commands.
    # The teleop slew ramps the previous command toward the request by at most these amounts,
    # so the command reaches max in _linear_accel_time / _angular_accel_time seconds.
    ...
    # Rotation gets its own scale so turning isn't twitchy at the high physical max angular speed
