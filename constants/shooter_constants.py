...
#Oscillation detected when doing feedforward tuning on NEO VORTEX, but not when doing Falcon 500
    ...
    _flywheel_motor_configs.slot0.with_k_s(0.115)
    _flywheel_motor_configs.slot0.with_k_v(0.1075)
    ...
    _flywheel_intake_motor_configs.current_limits.with_stator_current_limit(20)
