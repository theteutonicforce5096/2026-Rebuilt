...
#TODO Determine brake or coast mode and check if any need to be inverted
    ...
    _mechanim_wheel_configs.motor_output.with_neutral_mode(signals.NeutralModeValue.BRAKE)
    ...
    _mechanim_wheel_configs.slot0.with_k_s(0.15736)
    _mechanim_wheel_configs.slot0.with_k_v(0.12473)
